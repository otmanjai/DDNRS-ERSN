...
Various evaluated nuclear data libraries have been processed into the XMAS or SHEM binary formats required by **DRAGON5** code and can be found at https://openmc.org.Various evaluated nuclear data libraries have been processed into the HDF5
format required by OpenMC and can be found at https://www.polymtl.ca/merlin/libraries.htm.
